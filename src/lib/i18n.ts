...
const translations = {
  ...
  notifSystemBackup: { EN: "System Backup Complete", AR: "اكتملت النسخة الاحتياطية" },
  notifNewReport: { EN: "New Report Filed", AR: "تم تقديم بلاغ جديد" },
  notifUserBanned: { EN: "User Account Banned", AR: "تم حظر حساب مستخدم" },
  notifItemExpired: { EN: "Item Auto-Expired", AR: "انتهت صلاحية العنصر تلقائياً" },
  notifRoleChanged: { EN: "User Role Updated", AR: "تم تحديث دور المستخدم" },
  markAllAsRead: { EN: "Mark all as read", AR: "تحديد الكل كمقروء" },
  all: { EN: "All", AR: "الكل" },
  systemAlerts: { EN: "System Alerts", AR: "تنبيهات النظام" },
  notificationsPage: { EN: "Notifications", AR: "الإشعارات" },
  notificationsSubtitle: { EN: "View and manage all notifications", AR: "عرض وإدارة جميع الإشعارات" },
  filterByType: { EN: "Filter by type", AR: "تصفية حسب النوع" },
  ...
  noNotifications: { EN: "No notifications found", AR: "لا توجد إشعارات" },
  noNotificationsDesc: { EN: "You're all caught up! Check back later.", AR: "لا توجد إشعارات جديدة! تحقق لاحقاً." },
  today: { EN: "Today", AR: "اليوم" },
  yesterday: { EN: "Yesterday", AR: "أمس" },
  thisWeekLabel: { EN: "This Week", AR: "هذا الأسبوع" },
