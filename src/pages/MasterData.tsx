...
const tabsData: Record<string, { labelKey: TranslationKey; items: string[] }> = {
  colleges: {
    labelKey: "colleges",
    items: ["College of Engineering", "College of Medicine", "College of Computer Science & IT", "College of Business Administration", "College of Law", "College of Architecture", "College of Pharmacy", "College of Education"],
  },
  departments: {
    labelKey: "departments",
    items: ["Computer Engineering", "Civil Engineering", "Electrical Engineering", "Business Administration", "Accounting", "General Medicine", "Pharmacy", "Architecture & Design"],
  },
  locations: {
    labelKey: "locations",
    items: ["Engineering Faculty – Ground Floor", "Main Library", "IT Lab 1", "IT Lab 2", "IT Lab 3", "Cafeteria", "Student Center", "Parking Lot A", "Parking Lot B", "Lecture Hall A1", "Lecture Hall A2", "Admin Building", "Medical Faculty"],
  },
  categories: {
    labelKey: "categories",
    items: ["Electronics", "Documents & IDs", "Accessories", "Clothing", "Books & Stationery", "Keys", "Bags & Wallets", "Other"],
  },
};
      ...
      <div className="mt-4 rounded-lg border border-border bg-card shadow-card">
        <div className="flex items-center justify-between border-b border-border px-5 py-4">
          <h3 className="text-sm font-semibold text-card-foreground">
            {t(data.labelKey, lang)} ({data.items.length})
          </h3>
